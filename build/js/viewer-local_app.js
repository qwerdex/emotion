...
"undefined" == typeof RM && (RM = {}), function(t) {
    ...
    t.classes.Page = Backbone.View.extend({
        ...
        signalOnLoading: function() {
            ...
            function i() {
                ...
                e.trigger("loadAnimationsReady"))), t || (e.fireReadyTimeout = setTimeout(s, 200));
            }
            function s() {
    ...
    t.widgets.picture = t.classes.Widget.extend({
        ...
        getPictureUrl: function() {
            ...
            var e = (Modernizr.retina || t.scale.isOn(this.page.scale)) && this.picture.final2xUrl || this.picture.finalUrl;
